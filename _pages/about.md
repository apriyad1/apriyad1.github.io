...
<ul>
  <li> Fairness in Machine Learning.
  <li> Developing Representation learning techniques to mitigate Algorithmic bias in real-world applications.
  <li> Experience working in Neuro-symbolic networks and Deep learning frameworks for robust decision-making.
  <li> Integrating Fairness-aware frameworks in Large Language Models (LLMs).
  <li> Machine Learning Interpretability and Explainaibility.
</ul>
